...
class NullRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:helloworld.NullRequest) */ {
 public:
  ...
  inline NullRequest* New() const final {
    return CreateMaybeMessage<NullRequest>(nullptr);
  }

  NullRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  void InternalSwap(NullRequest* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "helloworld.NullRequest";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:helloworld.NullRequest)
 private:
  class _Internal;
...
class NumberRequest PROTOBUF_FINAL :
 ...
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "helloworld.NumberRequest";
  }
  protected:
